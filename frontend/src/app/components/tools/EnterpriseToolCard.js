    ...
    <>
      ...
      >
        ...
        <div className="p-4 flex flex-col items-center w-full">
          {/* Tool name and link */}
          <h3 className="text-lg font-bold flex items-center justofy-center">
            <a
          ...
          {/* Pagination dots - only for multiple tools and when modal is closed */}
          {hasMultipleTools && !isModalOpen && (
      ...
      {isModalOpen && (
        <CardModal
          ...
          category={category || currentTool.sector || ''}
          tools={displayTools}
